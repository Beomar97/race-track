...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	%	Headings
	%------------------------------------------------
	\textsc{\LARGE ZHAW Zurich University of Applied Sciences}\\[1.5cm] % Main heading such as the name of your university/college
	...
	{\large \mydate} % Date, change the \today to a set date if you want to be precise
